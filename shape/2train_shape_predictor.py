# python shape/2train_shape_predictor.py -t shape/data/labels_ibug_300W_eyes.xml -m shape/eye_predictor.dat
...
error = dlib.test_shape_predictor(args["training"], args["model"])
